...
class DataHRIR(Dataset):
    def __init__(self, input_path, hrir_path, noSubjID = False):
        ...
        print(" in MyDataset init --->>> Input size: ", torch.Tensor.size(self.input), " Target size: ", torch.Tensor.size(self.target))
